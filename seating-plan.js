    ...
    function addRule(divName){
      ...
      var ruleType = '<select name="ruletype" id ="' + id + '"> \
                    <option value = "sitsIn"> istuu </option>\
                    <option value = "sitsNext" class="selected"> vieressä </option>\
                    <option value = "sitsAway"> ei vieressä </option>\
                    </select>'
      ...
      //create rows
        ...
        for(var i = 1; i <= rowNumber ; i ++){
            if(i == 1){
                html += '<option value="row' + i + '">' + "eturivi" + "</option>";
            }
            else if (i == rowNumber){
                html += '<option value="row' + i + '">' + "takarivi" + "</option>";
            }
            else {
            html += '<option value="row' + i + '">' + "rivi "+ i + "</option>";
            }
        }
        $('#' + idd).append(html);
